  ...
  return (
    <Fragment>
      <div className="grid grid-cols-3 gap-x-3 gap-y-2 mt-10 text-center">
        <div className="col-span-2 rounded-full w-auto bg-purple-300 text-center  font-bold py-2 px-4">
          {getTunas}
        </div>
        <div className="col-span-1 rounded-full w-auto  bg-purple-300 text-center font-bold py-2 px-4">
          {getCabin}
        </div>
        <div className="rounded-full w-auto bg-purple-300 text-center font-bold py-2 px-4">
          {joinCabinWithFriends}
        </div>
        <div className="rounded-full w-auto bg-purple-300 text-center font-bold py-2 px-4">
          {joinCommmunity}
